...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>修改APP最新版本信息 <i class="fa fa-user"></i><small>${devUserSession}</small></h2>
            <div class="clearfix"></div>
      </div>
      <div class="x_title">
            <h2>历史版本列表</h2>
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
						...
						<tbody>
							<c:forEach var="appVersion" items="${appVersionList }" varStatus="status">
								<tr role="row" class="odd">
                                    <td tabindex="0" class="sorting_1">${appname}</td>
        ...
        <div class="x_content" style="display: block;">
         <br>
        <form class="form-horizontal form-label-left" action="appversionmodifysave.do" method="post" enctype="multipart/form-data">
           <input type="hidden" name="id" id="appId" value="${appVersionList[0].id}">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="versionSize" name="versionsize" value="${appVersionList[0].versionsize }"  required="required"
...
<script src="${pageContext.request.contextPath }/localjs/appversionmodify.js"></script>